...
<table class="table table-bordered table-hover m10" cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<td class="tableright"><input type="text" class="textbox require" name="adm_name" /></td>
	</tr>
	<tr>
		<td class="tableleft">密码:</td>
		<td class="tableright"><input type="password" class="textbox require" name="adm_password" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="tableright">
			...
			<?php if(is_array($role_name)): $i = 0; $__LIST__ = $role_name;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
		</td>
	</tr>
	<tr>
