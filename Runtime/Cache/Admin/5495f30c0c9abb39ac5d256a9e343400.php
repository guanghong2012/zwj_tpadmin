...
<body>
<?php if(!empty($adddate)): ?><script type="text/javascript" src="/zwj/Public/Admin/js/adddate.js"></script><?php endif; ?>
<?php if(!empty($editor)): ?><script type="text/javascript" charset="utf-8" src="/zwj/Public/editor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/zwj/Public/editor/ueditor.all.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/zwj/Public/editor/lang/zh-cn/zh-cn.js"></script><?php endif; ?>
...
<form action="" method="post" enctype="multipart/form-data" class="definewidth">
