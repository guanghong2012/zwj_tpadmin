...
<link rel="shortcut icon" href="/zwj/App/Home/View/mobile/image/favicon.ico">
<link rel="icon" href="/zwj/App/Home/View/mobile/image/favicon.gif" type="image/gif" >

<script type="text/javascript" src="/zwj/App/Home/View/mobile/js/jquery-1.11.1.min.js"></script>
<?php if(!empty($css)): if(is_array($css)): $i = 0; $__LIST__ = $css;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><link rel="stylesheet" type="text/css" href="/zwj/App/Home/View/mobile/css/<?php echo ($c); ?>" /><?php endforeach; endif; else: echo "" ;endif; endif; ?>
