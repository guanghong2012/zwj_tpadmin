...
class baseController extends Controller
{
    protected function _initialize() {
        ...
        if(isMobile() && C("MOBILE")){
            ...
            C("TMPL_PARSE_STRING.__HOME__",__ROOT__.'/App/Home/View/mobile');
            C("TMPL_PARSE_STRING.__CSS__",__ROOT__.'/App/Home/View/mobile/css');
            C("TMPL_PARSE_STRING.__JS__",__ROOT__.'/App/Home/View/mobile/js');
            C("TMPL_PARSE_STRING.__IMAGES__",__ROOT__.'/App/Home/View/mobile/image');

            $_GET['visit'] = "mobile";
            //获取需要加载的CSS
            $css = getFile("./App/Home/View/mobile/css/");
        }else{
            $_GET['visit'] = "default";
            //获取需要加载的CSS
            $css = getFile("./App/Home/View/default/css/");
        }
