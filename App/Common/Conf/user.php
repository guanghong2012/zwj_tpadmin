...
//定义回调URL通用的URL
define('URL_CALLBACK', 'http://localhost/index.php?m=Index&a=callback&type=');

return array(
	//腾讯QQ登录配置
	'THINK_SDK_QQ' => array(
		'APP_KEY'    => '101332107', //应用注册成功后分配的 APP ID
		'APP_SECRET' => 'c3843b8dada3102429cabd83001c807d', //应用注册成功后分配的KEY
